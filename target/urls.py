...
urlpatterns = [
    ...
    path('labeling/delReference/', target_view.delReference),
    path('labeling/calStft/', target_view.calStft),
    path('labeling/setPrimary/', target_view.setPrimary),
    path('labeling/setRefFilter/', target_view.setRefFilter),
